...
em paralelo, treina modelos Random Forest nos datasets reduzidos e compara com os resultados originais.
...
def process_dataset_with_parallel_selection(file_path, data_loader, visualizer):
    """
    ...
    try:
        ...
        instance_selector = ParallelInstanceSelector(
            ...
            init_fitness_cache=True,  # Ativa cache para melhor desempenho
            use_gpu=False
        )
        ...
        results = {
            ...
            'num_parallel_runs': instance_selector.num_parallel_runs
        }
        
        # Plota evolução do fitness para cada execução
        visualizer.plot_parallel_fitness_evolution(
            fitness_history,
            dataset_name=full_name,
...
def main():
    ...
    for file_path in csv_files:
        result = process_dataset_with_parallel_selection(file_path, data_loader, visualizer)
    ...
    if results:
        ...
        results_file = INSTANCE_SEL_DIR / "parallel_instance_selection_results.csv"
